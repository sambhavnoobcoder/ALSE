...
\caption{PATH C: Large-scale LM parity with 50M parameters. ALSE achieves 70\% better BPB than BPE with identical model architectures and training.}
\label{fig:lm_parity}
\end{figure}
...
\caption{PATH B: Distillation results showing ALSE achieves 60\% better BPB than byte-level students, eliminating tokenizer mismatch issues.}
