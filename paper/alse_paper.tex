...
% Configure hyperref to remove boxes around links
\hypersetup{
    colorlinks=true,
    linkcolor=black,
    citecolor=blue,
...
\begin{figure}[h]
\centering
\includegraphics[width=0.8\textwidth]{figures/fig1_bpb_comparison.png}
\caption{Main results: BPB comparison between ALSE and BPE across vocabulary sizes. ALSE achieves 62\%, 24\%, and 22\% improvements at vocab sizes 128, 512, and 2048 respectively.}
\label{fig:main_bpb}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.7\textwidth]{figures/fig2_scaling_curves.png}
\caption{BPB scaling with vocabulary size. ALSE maintains better BPB than BPE across all tested vocabulary sizes (128, 512, 2048).}
\label{fig:scaling}
\end{figure}
...
\subsection{Large-Scale LM Parity}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{figures/fig3_lm_parity.png}
\caption{Large-scale LM parity with 50M parameters. ALSE achieves 70\% better BPB than BPE with identical model architectures and training.}
\label{fig:lm_parity}
\end{figure}
...
\begin{figure}[h]
\centering
\includegraphics[width=0.6\textwidth]{figures/fig4_distillation.png}
\caption{Distillation results showing ALSE achieves 60\% better BPB than byte-level students, eliminating tokenizer mismatch issues.}
